...
public class MakeMyTrip 
{
	...
	public void selectDepartureDate()
	{
		...
		/*int ip_day = cal.get(Calendar.DAY_OF_MONTH);
		String ip_month = new SimpleDateFormat("MMMM").format(date);   //String.valueOf(cal.get(Calendar.MONTH));  // always 2 digits
		String ip_year = String.valueOf(cal.get(Calendar.YEAR));// 4 digit year
		String ip_month_year = ip_month.toUpperCase()+ " "+ ip_year;
		System.out.println(ip_day + ip_month_year);*/
